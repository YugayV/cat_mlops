...
from catboost_model.config.core import DATASET_DIR, TRAINED_MODEL_DIR, config
...
def save_pipeline(*, pipeline_to_persist) -> None:
    ...
    save_file_name = f"{config.app_config.pipeline_save_file}_{_version}.pkl"
...
def load_pipeline(*, file_name: str) -> object:
